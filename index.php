...
<html lang="en">
  ...
  <body>
    <div class="container-fluid jumbotron col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <a href='index.php'><h1>पोळीभाजी</h1></a>
        <h2 style="font-family: 'Comfortaa', cursive;">"GHAR JAISA KHAANA" NOW AT YOUR CLICK</h2>
        <div class="buttons">
          <?php
    ...
    <div class="row">
      <div class="container-fluid">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center headings" style="margin-top: -10px;"><h1><i class="fa fa-building" aria-hidden="true"></i>&nbsp;SEARCH BY LOCALITY</h1></div>
      </div>
    </div>
    <div class="row">
      <div class="container">
      ...
      <div class="container-fluid text-center">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 foot-content">
            <h4>Contact Us:</h4>
            <p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;help.service@polibhaji.com</p>
            <p><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;1800-194-234(toll-free)</p>
          </div>

          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 foot-content">
            <h4>Headquarters Address:</h4>
            <p>Block no. 304, Paradise Plaza, Bandra-Kurla Complex, Kurla(W)-400051</p>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 foot-content">
            <h4>Follow Us:</h4>
        ...
        <div class="row" style="margin-top:20px;">
          <div class="col-lg-12"><p style="color:#b3b3b3;">&copy;2016 POLIBHAJI ALL RIGHTS RESERVED</p></div>
        </div>
      </div>
    </div>
